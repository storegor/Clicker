...
first_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2, kCELL_H * 0), (kCELL_W // 2, 2 * kCELL_H - 2), 1)#
second_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + kCELL_W, kCELL_H * 0), (kCELL_W // 2 + kCELL_W, 2 * kCELL_H - 2), 1)#
third_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 2 * kCELL_W, kCELL_H * 0), (kCELL_W // 2 + 2 * kCELL_W, 2 * kCELL_H - 2), 1)#
fourth_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 3 * kCELL_W, kCELL_H * 0), (kCELL_W // 2 + 3 * kCELL_W, 2 * kCELL_H - 2), 1)#
last_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 4 * kCELL_W, kCELL_H * 0), (kCELL_W // 2 + 4 * kCELL_W, 2 * kCELL_H - 2), 1)#
...
c_click_column = pygame.draw.rect(screen, kBLACK, (kCELL_W // 2 - 1, kCELL_H, kCELL_W, kCELL_H * 1 - 1))
c_second_column = pygame.draw.rect(screen, kBLACK, (3 * (kCELL_W // 2) - 2, kCELL_H, kCELL_W, kCELL_H * 1 - 1))
autoclick_column = pygame.draw.rect(screen, kBLACK, (5 * (kCELL_W // 2) - 2, kCELL_H, kCELL_W, kCELL_H * 1 - 1))
amount_column = pygame.draw.rect(screen, kBLACK, (7 * (kCELL_W // 2) - 2, kCELL_H, kCELL_W, kCELL_H * 1 - 1))
...
def autominer():
    ...
    pygame.draw.rect(screen, kBLACK, (7 * (kCELL_W // 2) - 2, kCELL_H, kCELL_W, kCELL_H * 1 - 1))
    ...
    pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 3 * kCELL_W, kCELL_H * 0), (kCELL_W // 2 + 3 * kCELL_W, 2 * kCELL_H - 2), 1)
...
while is_work:#
    ...
    for event in pygame.event.get():#
        ...
        btc_line = pygame.draw.line(screen, kWHITE, (kCELL_W // 2, kCELL_H), (9 * (kCELL_W // 2) - 3, kCELL_H), 1)
        last_line = pygame.draw.line(screen, kWHITE, (kCELL_W // 2, 2 * kCELL_H - 1), (9 * (kCELL_W // 2) - 3, 2 * kCELL_H - 1), 1)
        ...
        third_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 2 * kCELL_W, kCELL_H * 0), (kCELL_W // 2 + 2 * kCELL_W, 2 * kCELL_H - 2), 1)
        fourth_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 3 * kCELL_W, kCELL_H * 0), (kCELL_W // 2 + 3 * kCELL_W, 2 * kCELL_H - 2), 1)
        last_bar = pygame.draw.line(screen, kWHITE, (kCELL_W // 2 + 4 * kCELL_W - 2, kCELL_H * 0), (kCELL_W // 2 + 4 * kCELL_W - 2, 2 * kCELL_H - 2), 1)
